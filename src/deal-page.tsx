        ...
        <Card className="mx-8 my-6 max-w-2xl ">
          <CardHeader>
            <div className="flex items-center space-x-2">
              <CardTitle className="text-3xl font-bold mb-2 tracking-normal">{deal.title}</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="flex items-center space-x-2 text-muted-foreground mb-4">
              <Clock className="w-4 h-4" />
              <span>{deal.occurrence}</span>
            </div>
            <div className="flex items-center space-x-2 text-muted-foreground mb-4">
              <MapPin className="w-4 h-4" />
              <a href="#" className="hover:underline">{deal.location}</a>
            </div>
